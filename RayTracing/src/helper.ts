...
export function setupGeometry(scene: THREE.Scene){
  ...
  var phongMaterialPurple = new THREE.MeshPhongMaterial( {
      color: 0x9400d3,
      specular: 0xaaaaaa,
      shininess: 150,
      reflectivity: 0,
  } ) as THREE.MeshPhongMaterial & { mirror: boolean };
  phongMaterialPurple.mirror = false;
  ...
  var sphere3 = new THREE.Mesh( sphereGeometry, phongMaterialPurple );
  sphere3.position.set( 50/300, - 250/300 + 5/300, - 100/300 );
  ...
  // right
  var planeright = new THREE.Mesh( planeGeometry, phongMaterialPurple );
